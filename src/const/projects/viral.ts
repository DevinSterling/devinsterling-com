...
const images: Image[] = [
  {
    ...
    alt: "Side bar on small-sized screens (i.e., mobile devices)"
  }, {
    ...
    alt: "Profile Page: Recent Posts of an administrator"
  }, {
    src: "/images/viral/viral_profile_page_user_posts.png",
    alt: "Profile Page: Recent Posts of a regular user"
  }, {
...
const VIRAL: Project = {
  ...
  synopsis:
    `Through an intuitive interface, guests can search, browse profiles, see recent/popular posts, and view commentary.
     ...
     Admins possess the ability to modify platform content, such as removing posts and users.
     Uses prepared statements, client/server-side validation, and privileged entry points using tokens to stop malicious users from accessing restricted information.`,
  thumbnail: images[16],
  color: '#ff006a',
  images,
};
